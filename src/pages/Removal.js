        ...
        <div className='flex flex-row'>
            ...
            <div className='bg-[#FAFAFB] h-lvh w-lvw flex flex-col'>
                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <button className='bg-[#605BFF] w-5/12 font-semibold text-xl text-[#FFFFFF] mt-12 p-3 rounded-lg flex flex-row items-center justify-center gap-x-2'><AiOutlineLoading3Quarters /></button>
                </div>
